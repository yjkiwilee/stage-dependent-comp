...
#   spp_vrs$sj$F2$f[1]
# )
# lambda(vrs_to_mpm(2, spp_vrs$sj$F2)$matA)
# 
# 
# test_comm_model <- sd_comm_models$g$S2S2[["1"]]
# test_comm_model
# #
# # test_comm_model$sp1_vr_sd$r[1] <- 0
# # test_comm_model$sp2_vr_sd$r[1] <- 0
# 
# test_tseries <- read_csv(
#   here("StageDependentComp","result_data","wp3",
#        paste0("sim_tseries_g.csv")),
#   col_types = cols(dd_vr = col_character(), st_dep_level = col_factor())
# )
# 
# test_tseries_part <- test_tseries %>%
#   filter(
#     sp1_name == "S2" & sp2_name == "S2" & st_dep_level == "1"
#   )
# 
# 
# test_tseries_part <- test_tseries_part %>%
#   left_join(
#     kmat_df,
...
# test_tseries_part
# 
# test_comm_project <- sdcomp_project(
#   test_comm_model,
#   c(250, 250),
#   c(250, 250),
#   timestep = 2000
# )
# 
# test_comm_project <- test_comm_project %>%
#   pivot_longer(
#     !time,
#     names_to = c("sp", "stage"),
#     names_sep = "_",
...
#   )
# 
# ggplot(test_comm_project, aes(x = time, y = n, color = sp, linetype = stage)) +
#   geom_line() +
#   theme_jun1()
# 
# test_comm_project <- sdcomp_project_vr(
#   test_comm_model,
#   c(250, 250),
#   c(250, 250),
#   timestep = 2000
...
#   )
# 
# hist(test_comm_project$vr_sp1_g1)
# 
# summary(lm(
#   vr_sp1_g1 ~ sp1_n + sp2_n + sp1_struct + sp2_struct,
#   test_comm_project
# ))
# 
# summary(lm(
#   vr_sp1_g1 ~ sp1_n + sp2_n,
#   test_comm_project
# ))
# 
# cor.test(test_comm_project$sp2_s1, test_comm_project$sp2_s2)
# 
# test_comm_model
# 
# # mean(test_comm_project$sp1_s1 /
# #        (test_comm_project$sp1_s1 + test_comm_project$sp1_s2), na.rm = TRUE)
# sd(test_comm_project$sp1_s1 + test_comm_project$sp1_s2, na.rm = TRUE)
# sd(test_comm_project$sp2_s1 + test_comm_project$sp2_s2, na.rm = TRUE)
# mean(test_comm_project$vr_sp1_r, na.rm = TRUE)
# 
# test_comm_model
# 
# lambda_from_vr(
...
#   spp_vrs$r$F2$s[2],
#   spp_vrs$r$F2$g[1],
#   mean(test_comm_project$vr_sp2_r, na.rm = TRUE),
#   spp_vrs$r$F2$f[1]
# )
# 
# ggplot(test_comm_project, aes(x = time, y = vr_sp2_g1)) +
#   geom_line()
# 
# sd(logistic(rnorm(1000, sd = 0.2) + logit(0.08)))
# sd(logistic(rnorm(1000, sd = 0.2) + logit(0.16)))
