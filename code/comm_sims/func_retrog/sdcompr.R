...
source(here("StageDependentComp", "code", "comm_sims", "func_retrog", "sdcompr_def_model.R"))

# Import sdcompr_mpm.R with functions related to generating Rage mpms
source(here("StageDependentComp", "code", "comm_sims", "func_retrog", "sdcompr_mpm.R"))

# Import sdcompr_projection.R with functions that project populations using a sdcomp model
source(here("StageDependentComp", "code", "comm_sims", "func_retrog", "sdcompr_projection.R"))

# Import sdcompr_long.R with functions for long-term dynamics analysis
source(here("StageDependentComp", "code", "comm_sims", "func_retrog", "sdcompr_long.R"))

# Import sdcompr_comp_manip.R with functions for manipulating competitive coefficients
source(here("StageDependentComp", "code", "comm_sims", "func_retrog", "sdcompr_comp_manip.R"))

# Import sdcompr_vr_manip.R with functions for manipulating vital rates
source(here("StageDependentComp", "code", "comm_sims", "func_retrog", "sdcompr_vr_manip.R"))
