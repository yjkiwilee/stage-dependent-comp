...
ggplot(sd_models_flh_m_long, aes(x = st_dep, y = avg)) +
  geom_point() +
  theme_jun2() +
  labs(
...
ggsave(here("StageDependentComp","figures","prelim","stoch_fastlh_varstdep_mean_zoom_mult.png"), width = 8, height = 5)
...
ggplot(sd_models_flh_sd_long, aes(x = st_dep, y = sd, color = species)) +
  geom_point(size = 0.7) +
...
# Save plot
ggsave(here("StageDependentComp","figures","prelim","stoch_fastlh_varstdep_sd_zoom_mult.png"), width = 4, height = 3.8, scale = 0.8)
