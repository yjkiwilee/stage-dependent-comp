...
# Save plot
ggsave(here("StageDependentComp", "figures", "census_analysis", "crowding", "test_plot.png"), test_plot_plt, width = FIG_W, height = FIG_H)
...
# Save plot
ggsave(here("StageDependentComp", "figures", "census_analysis", "crowding", "crowd_fct_distrib.png"), crowd_distrib_plt, width = FIG_W, height = FIG_H)
...
# Save plot
ggsave(here("StageDependentComp", "figures", "census_analysis", "crowding", "crowd_fct_distrib_focal_only.png"), crowd_distrib_plt_focal_only, width = FIG_W, height = FIG_H)
...
# Save plot
ggsave(here("StageDependentComp", "figures", "census_analysis", "crowding", "crowd_fct_distrib_focal_cat_only.png"), crowd_distrib_plt_focal_cat_only, width = FIG_W, height = FIG_H)
...
# Save plot
ggsave(here("StageDependentComp", "figures", "census_analysis", "crowding", "crowd_fct_distrib_hist.png"), crowd_distrib_hist_plt, width = FIG_W, height = FIG_H + 1.5)
...
# Save plot
ggsave(here("StageDependentComp", "figures", "census_analysis", "crowding", "crowd_fct_null_distrib.png"), sim_crowd_distrib_hist_plt, width = FIG_W, height = FIG_H + 1.5)
...
write_csv(crowd_fct_df,
          here("StageDependentComp", "result_data", "wp2", "focal_spp_crowding.csv"))
...
write_csv(merged_focal_data,
          here("StageDependentComp", "result_data", "wp2", "focal_spp_full_data.csv"))
