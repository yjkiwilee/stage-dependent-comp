...
model {
  ...
  bo_crwd = append_col(
    rep_row_vector(b_co, n_c),
    append_col(
      rep_row_vector(b_ho, n_h),
      rep_row_vector(b_oo, n_o)
    )
  );
  
  bi_crwd = append_col(
    rep_row_vector(b_ci, n_c),
    append_col(
      rep_row_vector(b_hi, n_h),
      rep_row_vector(b_oi, n_o)
    )
  );
