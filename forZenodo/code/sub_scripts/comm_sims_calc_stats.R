...
# Iterate through density-dependent vital rates, species combinations and
# stage-dependence. Note that the following four lines are commented out because
# those objects already exist from previously run scripts.
